...
public class MQViewPhotoDialog extends Dialog {
    ...
    public MQViewPhotoDialog(Context context) {
        super(context, MQResUtils.getResStyleID("MQDialog"));
        setContentView(MQResUtils.getResLayoutID("mq_dialog_view_photo"));
        ...
        mPhotoIv = (ImageView) findViewById(MQResUtils.getResIdID("iv_view_photo"));
