...
public class MQViewPhotoActivity extends Activity implements PhotoViewAttacher.OnViewTapListener, View.OnClickListener {
    ...
    private void initView() {
        ...
        mPhotoIv = (ImageView) findViewById(MQResUtils.getResIdID("photo_iv"));
        mProgressBar = (ProgressBar) findViewById(MQResUtils.getResIdID("progress_bar"));
    }
        ...
        new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    MQUtils.showSafe(MQViewPhotoActivity.this, getString(MQResUtils.getResStringID("mq_save_img_success"), MQUtils.getImageDir(MQViewPhotoActivity.this).getAbsolutePath()));
                } catch (IOException e) {
