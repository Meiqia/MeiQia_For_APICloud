...
public class MQPhotoPickerPreviewActivity extends Activity implements View.OnClickListener, PhotoViewAttacher.OnViewTapListener {
    ...
    private void initView() {
        setContentView(MQResUtils.getResLayoutID("mq_activity_photo_picker_preview"));
        ...
        mContentHvp = (MQHackyViewPager) findViewById(MQResUtils.getResIdID("content_hvp"));
        mChooseRl = (RelativeLayout) findViewById(MQResUtils.getResIdID("choose_rl"));
        mChooseTv = (TextView) findViewById(MQResUtils.getResIdID("choose_tv"));
    }
    ...
    public void onClick(View v) {
        if (v.getId() == MQResUtils.getResIdID("back_iv")) {
            ...
            finish();
        } else if (v.getId() == MQResUtils.getResIdID("choose_tv")) {
            ...
            if (mSelectedImages.contains(currentImage)) {
                ...
                mChooseTv.setCompoundDrawablesWithIntrinsicBounds(MQResUtils.getResDrawableID("mq_ic_cb_normal"), 0, 0, 0);
                renderTopRightBtn();
            } else {
                if (mMaxChooseCount == 1) {
                    // 单选
                    ...
                    mChooseTv.setCompoundDrawablesWithIntrinsicBounds(MQResUtils.getResDrawableID("mq_ic_cb_checked"), 0, 0, 0);
                    renderTopRightBtn();
                } else {
                    // 多选
    ...
    private class ImagePageAdapter extends PagerAdapter {
        ...
        public View instantiateItem(ViewGroup container, int position) {
            ...
            MQImage.displayImage(MQPhotoPickerPreviewActivity.this, imageView, mPreviewImages.get(position), MQResUtils.getResDrawableID("mq_ic_holder_dark"), MQResUtils.getResDrawableID("mq_ic_holder_dark"), MQUtils.getScreenWidth(MQPhotoPickerPreviewActivity.this), MQUtils.getScreenHeight(MQPhotoPickerPreviewActivity.this), null);
