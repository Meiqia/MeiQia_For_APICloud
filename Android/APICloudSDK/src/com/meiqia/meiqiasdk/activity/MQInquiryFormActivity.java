...
public class MQInquiryFormActivity extends MQBaseActivity {
    ...
    protected int getLayoutRes() {
        return MQResUtils.getResLayoutID("mq_activity_inquiry_form");
    }

    @Override
    protected void initView(Bundle savedInstanceState) {
        mQuestionTitleTv = (TextView) findViewById(MQResUtils.getResIdID("question_title"));
        mContainer = (LinearLayout) findViewById(MQResUtils.getResIdID("container_ll"));
    }
    ...
    private class FormItem implements View.OnClickListener {
        ...
        public FormItem(Context context, String target_kind, String target) {
            ...
            this.target = target;
            rootView = LayoutInflater.from(context).inflate(MQResUtils.getResLayoutID("mq_item_form_inquiry"), null);
            contentTb = (TextView) rootView.findViewById(MQResUtils.getResIdID("content_tv"));
