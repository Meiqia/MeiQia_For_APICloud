...
public class MQClientItem extends MQBaseBubbleItem {
    ...
    protected int getLayoutId() {
        return MQResUtils.getResLayoutID("mq_item_chat_right");
    }
    ...
    protected void initView() {
        ...
        sendingProgressBar = getViewById(MQResUtils.getResIdID("progress_bar"));
        sendState = getViewById(MQResUtils.getResIdID("send_state"));
    }
        ...
        if (sendingProgressBar != null) {
            switch (baseMessage.getStatus()) {
                ...
                case BaseMessage.STATE_FAILED:
                    ...
                    sendState.setBackgroundResource(MQResUtils.getResDrawableID("mq_ic_msg_failed"));
