...
public class MQRichTextItem extends MQBaseCustomCompositeView {
    ...
    protected int getLayoutId() {
        return MQResUtils.getResLayoutID("mq_item_rich_text");
    }

    @Override
    protected void initView() {
        mChatBox = findViewById(MQResUtils.getResIdID("root"));
        mSummaryTv = (TextView) findViewById(MQResUtils.getResIdID("content_summary_tv"));
        mPicIv = (MQImageView) findViewById(MQResUtils.getResIdID("content_pic_iv"));
    }
    ...
    public void onClick(View view) {
        int id = view.getId();
        if (id == MQResUtils.getResIdID("root")) {
    ...
    public void setMessage(RichTextMessage message, Activity activity) {
        try {
            ...
            MQImage.displayImage(activity, mPicIv, thumbnail, MQResUtils.getResDrawableID("mq_ic_holder_light"), MQResUtils.getResDrawableID("mq_ic_holder_light"), mImageWidth, mImageHeight, new MQImageLoader.MQDisplayImageListener() {
                @Override
