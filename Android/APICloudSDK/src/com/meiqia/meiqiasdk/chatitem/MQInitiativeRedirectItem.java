...
public class MQInitiativeRedirectItem extends MQBaseCustomCompositeView {
    ...
    protected int getLayoutId() {
        return MQResUtils.getResLayoutID("mq_item_useless_redirect");
    }

    @Override
    protected void initView() {
        mTipTv = getViewById(MQResUtils.getResIdID("tv_item_redirect_tip"));
    }

    @Override
    protected void setListener() {
        getViewById(MQResUtils.getResIdID("tv_useless_redirect_redirect_human")).setOnClickListener(this);
    }
