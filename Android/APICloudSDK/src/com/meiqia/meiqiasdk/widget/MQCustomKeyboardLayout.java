...
public class MQCustomKeyboardLayout extends MQBaseCustomCompositeView {
    ...
    protected int getLayoutId() {
        return MQResUtils.getResLayoutID("mq_layout_custom_keyboard");
    }

    @Override
    protected void initView() {
        mEmotionKeyboardLayout = getViewById(MQResUtils.getResIdID("emotionKeyboardLayout"));
        mRecorderKeyboardLayout = getViewById(MQResUtils.getResIdID("recorderKeyboardLayout"));
    }
