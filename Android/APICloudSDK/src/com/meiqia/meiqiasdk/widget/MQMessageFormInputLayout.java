...
public class MQMessageFormInputLayout extends MQBaseCustomCompositeView {
    ...
    protected int getLayoutId() {
        return MQResUtils.getResLayoutID("mq_layout_form_input");
    }

    @Override
    protected void initView() {
        mTipTv = getViewById(MQResUtils.getResIdID("tip_tv"));
        mContentEt = getViewById(MQResUtils.getResIdID("content_et"));
    }
