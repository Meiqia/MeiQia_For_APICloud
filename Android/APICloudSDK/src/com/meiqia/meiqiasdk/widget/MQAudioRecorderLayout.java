...
public class MQAudioRecorderLayout extends RelativeLayout implements MQAudioRecorderManager.Callback, View.OnTouchListener {
    ...
    public MQAudioRecorderLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        View.inflate(context, MQResUtils.getResLayoutID("mq_layout_audio_recorder"), this);
        mStatusTv = (TextView) findViewById(MQResUtils.getResIdID("tv_audio_recorder_status"));
        mRecorderIv = (ImageView) findViewById(MQResUtils.getResIdID("iv_audio_recorder_recorder"));
        ...
        if (mCurrentState != status) {
            ...
            switch (mCurrentState) {
                case STATE_NORMAL:
                    ...
                    mRecorderIv.setImageResource(MQResUtils.getResDrawableID("mq_voice_level1"));
                    break;
                ...
                case STATE_WANT_CANCEL:
                    ...
                    mRecorderIv.setImageResource(MQResUtils.getResDrawableID("mq_voice_want_cancel"));
                    break;
            }
        }
    }
