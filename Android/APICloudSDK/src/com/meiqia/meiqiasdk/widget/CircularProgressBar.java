...
public class CircularProgressBar extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        backgroundColor = getResources().getColor(MQResUtils.getResColorID("mq_circle_progress_bg"));
        color = getResources().getColor(MQResUtils.getResColorID("mq_circle_progress_color"));
